...
try {
    ...
    // Guardar el estado actual antes de cualquier actualización
    ...
    <div class="editar-container">
        ...
        <?php else: ?>
            ...
            <div class="notificacion-info">
                <strong>📧 Notificaciones activadas:</strong> El cliente recibirá un correo automático cuando cambies el estado de este reclamo.
            </div>
